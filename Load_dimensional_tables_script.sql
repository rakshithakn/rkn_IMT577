...
INSERT INTO DIM_PRODUCT(
  "SourceProductID", "SourceProductTypeID", 
  "SourceProductCategoryID", "ProductName", 
  "ProductType", "ProductCategory", 
  "ProductRetailPrice", "ProductWholesalePrice", 
  "ProductCost", "ProductRetailProfit", 
  ...
  SELECT 
    ...
    (
      (sp.WHOLESALEPRICE - sp.COST) / sp.WHOLESALEPRICE
    ) * 100 AS "ProductProfitMarginUnitPercent" 
  FROM 
    STAGE_PRODUCT sp, 
...
INSERT INTO DIM_RESELLER(
  "DimLocationID", "SourceResellerID", 
...
INSERT INTO DIM_CUSTOMER(
  "DimLocationID", "SourceCustomerID", 
...
INSERT INTO DIM_CHANNEL(
  "SourceChannelID", "SourceChannelCategoryID", 
